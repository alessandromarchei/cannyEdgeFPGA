...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/alessandro/Xilinx/Vivado/2024.2/data/xsim"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xbip_utils_v3_0_14 c_reg_fd_v12_0_10 xbip_dsp48_wrapper_v3_0_6 xbip_pipe_v3_0_10 c_addsub_v12_0_19 mult_gen_v12_0_22 axi_utils_v2_0_10 cordic_v6_0_23)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb conv_block_gaussian.wdb xsim.dir libdpi.so)
