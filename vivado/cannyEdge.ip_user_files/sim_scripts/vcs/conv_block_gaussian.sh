...
#
# Script generated by Vivado on Mon Jan 20 14:15:42 CET 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : conv_block_gaussian.sh
...
#
# Usage        : conv_block_gaussian.sh
#                conv_block_gaussian.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                conv_block_gaussian.sh [-reset_run]
#                conv_block_gaussian.sh [-reset_log]
#                conv_block_gaussian.sh [-help]
#
...
#                script (type 'conv_block_gaussian.sh -help' for more information).
#
...
design_libs=(xbip_utils_v3_0_14 c_reg_fd_v12_0_10 xbip_dsp48_wrapper_v3_0_6 xbip_pipe_v3_0_10 c_addsub_v12_0_19 mult_gen_v12_0_22 axi_utils_v2_0_10 cordic_v6_0_23 xil_defaultlib)

# simulation root library directory
sim_lib_dir="vcs_lib"

# script info
echo -e "conv_block_gaussian.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./conv_block_gaussian.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  vhdlan -work cordic_v6_0_23 $vhdlan_opts \
  ...
  "../../../../../../../../Politecnico\\ Di\\ Torino\\ Studenti\\ Dropbox/Alessandro\\ Marchei/GITHUB_proj/cannyEdgeFPGA/src/params.sv" \
  "../../../../../../../../Politecnico\\ Di\\ Torino\\ Studenti\\ Dropbox/Alessandro\\ Marchei/GITHUB_proj/cannyEdgeFPGA/src/lut_arctang.sv" \
  "../../../../../../../../Politecnico\\ Di\\ Torino\\ Studenti\\ Dropbox/Alessandro\\ Marchei/GITHUB_proj/cannyEdgeFPGA/src/lineBuffer.sv" \
  "../../../../../../../../Politecnico\\ Di\\ Torino\\ Studenti\\ Dropbox/Alessandro\\ Marchei/GITHUB_proj/cannyEdgeFPGA/src/reduction_tree.sv" \
  "../../../../../../../../Politecnico\\ Di\\ Torino\\ Studenti\\ Dropbox/Alessandro\\ Marchei/GITHUB_proj/cannyEdgeFPGA/src/conv_block_gaussian.sv" \
  "../../../../../../../../Politecnico\\ Di\\ Torino\\ Studenti\\ Dropbox/Alessandro\\ Marchei/GITHUB_proj/cannyEdgeFPGA/src/conv_block_sobel.sv" \
  "../../../../../../../../Politecnico\\ Di\\ Torino\\ Studenti\\ Dropbox/Alessandro\\ Marchei/GITHUB_proj/cannyEdgeFPGA/src/sobel_arctan.sv" \
  "../../../../../../../../Politecnico\\ Di\\ Torino\\ Studenti\\ Dropbox/Alessandro\\ Marchei/GITHUB_proj/cannyEdgeFPGA/src/sobel_magnitude.sv" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.conv_block_gaussian xil_defaultlib.glbl -o conv_block_gaussian_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./conv_block_gaussian_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key conv_block_gaussian_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc conv_block_gaussian_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./conv_block_gaussian.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: conv_block_gaussian.sh [-help]\n\
Usage: conv_block_gaussian.sh [-step]\n\
Usage: conv_block_gaussian.sh [-lib_map_path]\n\
Usage: conv_block_gaussian.sh [-reset_run]\n\
Usage: conv_block_gaussian.sh [-reset_log]\n\
Usage: conv_block_gaussian.sh [-keep_index]\n\
Usage: conv_block_gaussian.sh [-noclean_files]\n\n\
